Feature: Test loan account apis
  ...
  @testThatICanCreateLoanAccountAndTransitionToAdvanceStagesAndAfterIcReviewDecisionLevelOneWeRouteToIcReviewLevelTwoFirstCycle
  Scenario: Test That I Can Create Loan Account And TransitionToAdvancedStagesAndAfterIcReviewDecisionLevelOneWeRouteToIcReviewLevelTwoFirstCycle
           #- Enable configuration  ---Add-More-Stages-To-A-Loan-Life-Cycle---
    *  def configName = 'Add-More-Stages-To-A-Loan-Life-Cycle'
    *  def response = call read('classpath:features/portfolio/configuration/configurationsteps.feature@findByNameStep') { configName : '#(configName)' }
    *  def configurationId = response.globalConfig.id
  ...
  @testThatICanCreateLoanAccountAndTransitionToAdvanceStagesAndAfterIcReviewDecisionLevelOneWeRouteToIcReviewLevelTwoSecondCycle
  Scenario: Test That I Can Create Loan Account And TransitionToAdvancedStagesAndAfterIcReviewDecisionLevelOneWeRouteToIcReviewLevelSecondCycle
