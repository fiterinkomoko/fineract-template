...
@CommandType(entity = "LOANICREVIEWDECISIONLEVELTWO", action = "REJECT")
public class LoanIcReviewDecisionLevelTwoRejectCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        // Delegate to dynamic handler for level 2 reject
        return this.dynamicCommandHandler.processIcReviewDecision(command, 2, false);
    }
}
