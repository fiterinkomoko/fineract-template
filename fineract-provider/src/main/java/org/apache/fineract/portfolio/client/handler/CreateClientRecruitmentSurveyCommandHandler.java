...
@Service
@CommandType(entity = "CLIENTRECRUITMENTSURVEY", action = "CREATE")
public class CreateClientRecruitmentSurveyCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand command) {
        ...
        return this.clientRecruitmentSurveyWritePlatformService.create(command.getClientId(), command);
    }
