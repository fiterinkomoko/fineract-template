...
public interface LoanDisbursementInstructionRepository extends JpaRepository<LoanDisbursementInstruction, Long> {

    Optional<LoanDisbursementInstruction> findByDisbursementProviderCodeAndIdempotencyKey(String disbursementProviderCode,
