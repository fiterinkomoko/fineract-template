...
public class ClientCollateralManagementAdditionalDetails extends AbstractPersistableCustom {
    ...
    public ClientCollateralManagementAdditionalDetails(ClientCollateralManagement clientCollateral, String upiNo, String chassisNo, String collateralOwnerFirst, String idNoOfCollateralOwnerFirst, String collateralOwnerSecond, String idNoOfCollateralOwnerSecond,
                                                    BigDecimal worthOfCollateral, CodeValue province,
                                                    CodeValue district, CodeValue sector, CodeValue cell, CodeValue village) {
    ...
    public static ClientCollateralManagementAdditionalDetails createNew(final ClientCollateralManagement clientCollateral, JsonCommand command, final CodeValue province, final CodeValue district,
                                                                        final CodeValue sector, final CodeValue cell, final CodeValue village) {
        ...
        return new ClientCollateralManagementAdditionalDetails(clientCollateral, upiNo, chassisNo, collateralOwnerFirst, idNoOfCollateralOwnerFirst, collateralOwnerSecond, idNoOfCollateralOwnerSecond, worthOfCollateral, province, district, sector, cell, village);
    }
    ...
    public Map<String, Object> update(JsonCommand command) {
        ...
        if(command.isChangeInStringParameterNamed(ClientApiConstants.idNoOfCollateralOwnerFirstParamName, this.idNoOfCollateralOwnerFirst)) {
        ...
        if(command.isChangeInStringParameterNamed(ClientApiConstants.idNoOfCollateralOwnerSecondParamName, this.idNoOfCollateralOwnerSecond)) {
