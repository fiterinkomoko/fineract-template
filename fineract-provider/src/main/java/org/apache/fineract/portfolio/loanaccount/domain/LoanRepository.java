...
public interface LoanRepository extends JpaRepository<Loan, Long>, JpaSpecificationExecutor<Loan> {
    ...
    @Query("select loan from Loan loan where loan.glim.id = :glimId and loan.loanStatus = :loanStatus")
    List<Loan> findLoanByGlimIdAndLoanStatus(@Param("glimId") Long glimId, @Param("loanStatus") Integer loanStatus);
