...
@Service
@CommandType(entity = "CLIENTRECRUITMENTSURVEY", action = "UPDATE")
public class UpdateRecruitmentSurveyCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand command) {
        ...
        return this.clientRecruitmentSurveyWritePlatformService.update(command.entityId(), command);
    }
