...
public final class LoanSchedulePeriodData {
    ...
    public static LoanSchedulePeriodData repaymentPeriodFull(final Long loanId, final Long installmentId, final Integer periodNumber,
     ...
     * with what portion of each is paid.
     */
    private LoanSchedulePeriodData(final Long loanId, final Long installmentId, final Integer periodNumber, final LocalDate fromDate,
