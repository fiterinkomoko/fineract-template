...
public final class ClientBusinessDetailDataValidator {
    ...
    public void validateForCreate(final long clientId, String json) {
        ...
        LocalDate businessCreationDate = null;
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.businessCreationDate, element)) {
            businessCreationDate = this.fromApiJsonHelper.extractLocalDateNamed(ClientApiConstants.businessCreationDate, element);
            baseDataValidator.reset().parameter(ClientApiConstants.businessCreationDate).value(businessCreationDate).notNull();
        }
