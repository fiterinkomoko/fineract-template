...
@Service
@CommandType(entity = "LOAN", action = "VERIFYLOANREPORTJSONONMETROPOLCRBKENYA")
public class VerifyLoanReportJsonOnMetropolCrbKenyaCommandHandler implements NewCommandSourceHandler {

    private final MetropolCrbVerificationWritePlatformService metropolCrbVerificationWritePlatformService;

    @Autowired
    public VerifyLoanReportJsonOnMetropolCrbKenyaCommandHandler(
    ...
    public CommandProcessingResult processCommand(JsonCommand command) {
        return this.metropolCrbVerificationWritePlatformService.verifyLoanReportJsonOnMetropolKenya(command.entityId(), command);
    }
}
