...
public class WhatsAppCampaignTimeLine {
    ...
    public WhatsAppCampaignTimeLine(final LocalDate submittedOnDate, final String submittedByUsername, final LocalDate activatedOnDate,
