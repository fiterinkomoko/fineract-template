...
public class VerifyLoanOnMetropolCrbKenyaCommandHandler implements NewCommandSourceHandler {
    ...
    public VerifyLoanOnMetropolCrbKenyaCommandHandler(
            final MetropolCrbVerificationWritePlatformService transUnionCrbVerificationWritePlatformService) {
        this.metropolCrbVerificationWritePlatformService = transUnionCrbVerificationWritePlatformService;
    }
