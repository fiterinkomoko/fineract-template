...
public enum JobName {
    ...
    POST_LOAN_ACCOUNTS_TO_KIVA("Post Loan Accounts to Kiva"), //
    POST_CUSTOMERS_TO_ODDO("Post Customers To Odoo"), //
    POST_LOAN_REPAYMENTS_TO_KIVA("Post Loan Repayments to Kiva"), //
